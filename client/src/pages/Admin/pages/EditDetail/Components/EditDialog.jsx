...
export const EditDialog = ({ close, pk }) => {
    ...
    const alertWiring = (state) => {
        ...
        axios.post(`${api}/api/v1/admin/board/${pk}/edit-request/${state}`, {}, {
            headers: {
        ...
        <section className="dialog-section">
            <div className="dialog">
                ...
                <div className="dialog-footer detail-footer">
                    <button onClick={()=>alertWiring(true)}>게시글 숨기지 않기</button>
                    <button onClick={()=>alertWiring(false)}>게시글 숨기기</button>
                </div>
            </div>
        </section>
    )
